...
const q2 = (req, res) => {
  ...
  res.render("pages/question2", { sentence, mynameis: "Rupy" });
};
...
const q3 = (req, res) => {
  ...
  res.render("pages/question3", { person: homer });
};
...
const q4 = (req, res) => {
  ...
  let top3Names = popularGirlNames.slice(0, 3);

  res.render("pages/question4", { top3Names: top3Names });
};
